...
for label in labels:
    ...
    for tofhir in ['2X','2C']:
        ...
        if (tofhir == '2X'):
            gData_scaled[tofhir,label].SetLineColor(plotAttrs['2C'][1])
            gData_scaled[tofhir,label].SetMarkerColor(plotAttrs['2C'][1])
            ...
            leg.AddEntry(gData_scaled[tofhir,label], '%s - scaled'%plotAttrs['2C'][2],'PL')
