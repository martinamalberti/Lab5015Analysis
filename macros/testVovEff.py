...
for ov in [0.60, 0.80, 1.00, 1.25, 1.50, 2.00]:
    ovEff = getVovEffDCR(data, 'HPK_2E14_LYSO815_T-35C', ('%.02f'%ov))[0]
    dcr   = getVovEffDCR(data, 'HPK_2E14_LYSO815_T-35C', ('%.02f'%ov))[1]
    current = getVovEffDCR(data, 'HPK_2E14_LYSO815_T-35C', ('%.02f'%ov))[2]
  
    staticCurrent = dcr*1E09 * Gain('HPK-PIT-C25-ES2', ovEff, '2E14') * 1.602E-19;
    staticPower = staticCurrent * (37. + ovEff) * 1000.; # P  = V I (in mW)   

    print(current, staticCurrent*1E3)
