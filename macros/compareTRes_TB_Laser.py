...
fnames = { (25, 'TB') : '/afs/cern.ch/work/m/malberti/MTD/TBatFNALMar2023/Lab5015Analysis/plots/summaryPlots_HPK_nonIrr_LYSO813.root',
           (20, 'TB') : '/afs/cern.ch/work/m/malberti/MTD/TBatFNALMar2023/Lab5015Analysis/plots/summaryPlots_HPK_nonIrr_LYSO814.root',
           (15, 'TB') : '/afs/cern.ch/work/m/malberti/MTD/TBatFNALMar2023/Lab5015Analysis/plots/summaryPlots_HPK_nonIrr_LYSO528.root',
...
gnames = { (25, 'TB') : 'g_deltaT_totRatioCorr_bestTh_vs_vov_enBin01_average',
...
plotAttrs = { (25, 'TB') : [20, ROOT.kBlack,  'TB - 25#mum SiPMs'],
              (20, 'TB') : [20, ROOT.kRed,  'TB - 20#mum SiPMs' ],
              (15, 'TB') : [20, ROOT.kGreen,'TB - 15#mum SiPMs'],
              (25, 'Laser') : [24, ROOT.kBlack, 'Laser - 25#mum SiPMs'],
              (20, 'Laser') : [24, ROOT.kRed+2,   'Laser - 20#mum SiPMs'],
              (15, 'Laser') : [24, ROOT.kGreen+2,  'Laser - 15#mum SiPMs'],
}


c = ROOT.TCanvas('c_comparison_TB_Laser_cellSizes','c_comparison_TB_Laser_cellSizes')
...
for data in ['Laser', 'TB']:
    for cell in [25,20,15]:
        ...
        g[(cell,data)] = f[(cell,data)].Get(gnames[(cell,data)])
