...
#HPK_15 um - TB CERN June2022
data_structs.append(
        DataStruct(
            sipm = 'HPK_nonIrr_LYSO528',
            sipmType = 'HPK-MS',
            fName = '/eos/cms/store/group/dpg_mtd/comm_mtd/TB/MTDTB_H8_Jun2022/ANALYSIS/moduleCharacterization/HPK_nonIrr_LYSO528_T10C_summary.root',
            fNamePS = '/eos/cms/store/group/dpg_mtd/comm_mtd/TB/MTDTB_H8_Jun2022/ANALYSIS/pulseShapes/pulseShape_HPK_nonIrr_LYSO528_T10C',
            label = 'HPK(15#mum)+LYSO528',
            LO = 1323,
            tau = 38.6,
            marker = 20,
...
#outdir = '/eos/user/m/malberti/www/MTD/TOFHIR2X/MTDTB_FNAL_Mar23/timeResolution_vs_Vov_HPK_cellSizes/'
#outdir = '/eos/user/m/malberti/www/MTD/TOFHIR2X/MTDTB_FNAL_Mar23/timeResolution_vs_Vov_HPK_Cgrid/'
outdir = '/eos/user/m/malberti/www/MTD/TOFHIR2X/MTDTB_CERN_Jun22/timeResolution_vs_Vov_HPK_nonIrr/'
...
#outfile   = ROOT.TFile.Open(outdir+'/plots_timeResolution_HPK_nonIrr_TBMar23_cellSizes.root','recreate')  
#outfile   = ROOT.TFile.Open(outdir+'/plots_timeResolution_HPK_nonIrr_TBMar23_Cgrid.root','recreate')  
outfile   = ROOT.TFile.Open(outdir+'/plots_timeResolution_HPK_nonIrr_TBJune22.root','recreate')  
...
for ds in data_structs:
    ...
    latex.Draw()
    outfile.cd()
    g_data_average[ds.sipm].Write('g_data_vs_Vov_average_%s'%ds.sipm)
