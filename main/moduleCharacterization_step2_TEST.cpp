...
// ---- Draw  DeltaT plots
void drawDeltaT(TCanvas *& c, TH1F *histo, TF1 *& fitFunc, std::string xaxis_label, std::string latex_label, bool drawSame ){
  ...
  //fitFunc = new TF1(Form("fitFunc_%s_%s",fit_label.c_str(), labelLR_energyBin.c_str()),"gaus",-10000, 10000);
	  ...
	  for(int iEnergyBin = 1; iEnergyBin <= nEnergyBins; ++iEnergyBin)
	    {
	      ...
	      drawDeltaT(c, histo, fitFunc, "energy-corrected", "energyCorr",false);
	      ...
	      drawDeltaT(c2, histo, fitFunc, "ToT-corrected", "ToTcorr", false);
	      ...
	      drawDeltaT(c, histo, fitFunc, "", "raw", true);
	      drawDeltaT(c2, histo, fitFunc, "", "raw", true);
	  ...
	  for(int iEnergyBin = 1; iEnergyBin <= nEnergyBins; ++iEnergyBin)
	    {
	      ...
	      c = new TCanvas(Form("c_deltaT_energyRatioPhaseCorr_%s",labelLR_energyBin.c_str()),Form("c_deltaT_energyRatioPhaseCorr_%s",labelLR_energyBin.c_str()));
              ...
              TF1* fitFunc = new TF1(Form("fitFunc_energyRatioPhaseCorr_%s",labelLR_energyBin.c_str()),"gaus",-10000, 10000);
              drawDeltaT(c, histo, fitFunc, "energy-corrected", "energyCorr",false);
	      ...
	      fitFunc = new TF1(Form("fitFunc_totRatioPhaseCorr_%s",labelLR_energyBin.c_str()),"gaus",-10000, 10000);
              drawDeltaT(c, histo, fitFunc, "phase-corrected", "phaseCorr",false);
	      ...
	      histo -> SetLineWidth(2);
              ...
              fitFunc = new TF1(Form("fitFunc_totCorr_%s",labelLR_energyBin.c_str()),"gaus",-10000, 10000);
              drawDeltaT(c, histo, fitFunc, "ToT-corrected", "totCorr", false);
